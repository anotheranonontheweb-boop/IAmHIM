...
export default function StudentProfilePage() {
  ...
  const section = typeof window !== "undefined" ? localStorage.getItem("userSection") || "10-A" : "10-A"
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            <div>
              ...
              <div className="flex gap-3 mt-2">
                <span className="px-3 py-1 bg-[#4361ee] text-white text-sm rounded-full">Student</span>
